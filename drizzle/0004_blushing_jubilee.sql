...
DO $$ BEGIN
 ALTER TABLE "code_messages" ADD CONSTRAINT "code_messages_sender_id_users_id_fk" FOREIGN KEY ("sender_id-id") REFERENCES "users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
